...
const generateOpinion = async (context, userPrompt) => {
  ...
  0. Najpierw sprawdź, czy przedstawione treści mają wyraźny związek z tematem użytkownika.
    ...
    - Jeśli nie - napisz wyraźnie, że dostępne materiały nie są wystarczająco związane z tematem, by przeprowadzić rzetelną analizę. Nie wymyślaj wtedy żadnych opinii na siłę. Podsumuj, że tamat nie budzi zainteresowania reporterów TVP Info. Dodaj zdanie o tym, co sądzisz o pomijaniu tej kwestii.
